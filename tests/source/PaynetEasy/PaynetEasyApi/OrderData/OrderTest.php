...
class OrderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSerialize()
    {
        ...
        $this->assertEquals('C:40:"PaynetEasy\PaynetEasyApi\OrderData\Order":34:{a:1:{s:6:"status";s:8:"approved";}}', $serialized);
    }

    public function testUnserialize()
    {
        $order = unserialize('C:40:"PaynetEasy\PaynetEasyApi\OrderData\Order":34:{a:1:{s:6:"status";s:8:"approved";}}');
