...
if (!isset($_GET['stage']))
{
     ...
     * @see \PaynetEasy\PaynetEasyApi\Query\PreauthFormQuery::$requestFieldsDefinition
     ...
     * @see \PaynetEasy\PaynetEasyApi\Query\PreauthFormQuery::updatePaymentOnSuccess()
     */
    $getPaymentProcessor()->executeQuery('preauth-form', $paymentTransaction);
}
/**
